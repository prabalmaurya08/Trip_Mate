...
import 'package:trip_mate/features/checklist/data/checklist_item.dart';
...
Future<void> main() async {
  ...
  Hive.registerAdapter(ItineraryPlanAdapter());

  // ✅ Open required boxes
  await Hive.openBox<ChecklistItem>('checklistBox');
  await Hive.openBox<ItineraryPlan>('itineraryBox');
